...
<html>
    ...
    <body>
        ...
        <table style="border: 1px solid black" id="table"  class="table table-bordered">
        ...
        <tbody style="border: 1px solid black">
            ...
            while ($row = pg_fetch_array($getdata)) {
                echo "<tr><td style='border: 1px solid black'>" . $row['id'] . "</td><td style='border: 1px solid black'>" . $row['username'] . "</td><td style='border: 1px solid black'>" . $row['password'] . "</td><td><a href='form.php?edit=1&delete=0&id=" . $row['id'] . "'><button type='button'>EDIT</button></a> &nbsp;&nbsp;<a href='form.php?edit=0&delete=1&id=" . $row['id'] . "'><button type='button'>DELETE</button></a></td></tr>";
            }
            ?>
        </tbody>
    </table>
